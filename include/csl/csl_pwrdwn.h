 ...
 *  Revision History
 *  ===============
 *  11-Nov-2005 brn Updated the PWERDWN module with the spec 
                    "GEM_UMC_rev1020_mistral_jz20050124.pdf". Removed the 
                    CSL_PwrdwnL2Auto structure and CSL_PwrdwnAutoPage structure 
...
/** @brief This will give the prot information or PWRDWn module
 */
typedef struct {
    /** port number */
    Bool  portNum;
 ...
 */
typedef struct CSL_PwrdwnConfig{
    /** PDCCMD register */
    Uint32 PDCCMD;         
    ...
    /** Per page manual sleep0 */
    Uint32 L2PDSLEEP0;
    
    /** Per page manual sleep1 */
    Uint32 L2PDSLEEP1;
} CSL_PwrdwnConfig;

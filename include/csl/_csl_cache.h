...
#define CSL_CACHE_EMIFA_PATCH() {                         \
                                 CSL_CACHE_EMIFA_REG = 0; \
                                 CSL_CACHE_EMIFA_REG; }
#define CSL_CACHE_EMIFB_PATCH() {                         \
                                 CSL_CACHE_EMIFB_REG = 0; \
                                 CSL_CACHE_EMIFB_REG; }

#else

#define CSL_CACHE_EMIF_MASK  0xfffffffc
#define CSL_CACHE_EMIFB_MASK 0

/* TB Status register */
#define CSL_CACHE_EMIFA_REG     *(volatile unsigned int*) 0x01C00000
#define CSL_CACHE_EMIFA_PATCH() {                        \
                                 CSL_CACHE_EMIFA_REG = 0;\
                                 CSL_CACHE_EMIFA_REG; }
#define CSL_CACHE_EMIFB_PATCH() {}

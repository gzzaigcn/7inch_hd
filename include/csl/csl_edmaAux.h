 ...
 *
 *   <b> Pre Condition </b>
 *   @n  All @a CSL_edmaInit(), @a CSL_edmaOpen(), @a CSL_edmaChannelOpen()
 *       must be  invoked successfully in that order before
 *       @a CSL_edmaChannelQueryParamMap() can  be invoked. If the channel is
 *       opened in context of a Region, @a CSL_edmaRegionOpen() may also need
 *       to be invoked before this API.
 *
 *   <b> Post Condition </b>
 *   @n  None
 *
 ...
 *  be invoked successfully in that order before @a CSL_edmaChannelEnable() can
 ...
 *   <b> Pre Condition </b>
 *   @n  All @a CSL_edmaInit(), @a CSL_edmaOpen(), @a CSL_edmaChannelOpen() must
 *  be invoked successfully in that order before @a CSL_edmaHwChannelDisable()
 ...
 *
 *   <b> Pre Condition </b>
 *   @n All @a CSL_edmaInit(),@a CSL_edmaOpen(),@a CSL_edmaChannelOpen() must be
 ...
 *   <b> Pre Condition </b>
 *   @n  All @a CSL_edmaInit(), @a CSL_edmaOpen(), @a CSL_edmaChannelOpen() must
 *  be invoked successfully in that order before @a CSL_edmaChannelEventClear()
 *  can be invoked. If the channel is opened in context of a Region,
 *  @a CSL_edmaRegionOpen() may also need to be invoked before this API. If a
 *  Shadow region is used then care of the DRAE settings must be taken.
 *
 ...
 *   <b> Pre Condition </b>
 *   @n  All @a CSL_edmaInit(), @a CSL_edmaOpen(), @a CSL_edmaChannelOpen() must
 *  be invoked successfully in that order before @a CSL_edmaChannelSetTrigWord()
 *  can be invoked. If the channel is opened in context of a Region, @a
 ...
 *   <b> Pre Condition </b>
 *   @n  All @a CSL_edmaInit(), @a CSL_edmaOpen(), @a CSL_edmaChannelOpen() must
 *  be invoked successfully in that order before @a CSL_edmaChannelSetEvtQue()
 *  can be invoked. If the channel is opened in context of a Region,
 *  @a CSL_edmaRegionOpen() may also need to be invoked before this API.
 *
 *   <b> Post Condition </b>
 ...
 *   <b> Pre Condition </b>
 *   @n  All @a CSL_edmaInit(), @a CSL_edmaOpen(), must be
 *  called successfully in that order before @a CSL_edmaGetMemoryProtectAttrib()
 *  can be called.
 *
 *   <b> Post Condition </b>
 *   @n  None
 ...
 *   <b> Pre Condition </b>
 *   @n  All @a CSL_edmaInit(), @a CSL_edmaOpen(), must be
 *  called successfully in that order before @a CSL_edmaGetMemoryFaultError()
 *  can be called.
 *
 *   <b> Post Condition </b>
 *   @n  None
 ...
 *
 *   <b> Pre Condition </b>
 *   @n  The EDMA must be succesfully initializedvia @a CSL_edmaInit().
 ...
 *
 *   <b> Pre Condition </b>
 *   @n  @a CSL_edmaInit(),CSL_edmaRegionOpen must have been called successfully

...
typedef enum {
    ...
    CSL_EDMA_CMD_INTERRUPT_CLEAR,      /**< (Arg: @a #CSL_BitMask32* )Clears
                                        *   specified (Bitmask)pending
                                        *   interrupt at Module Level
                                        */
...
typedef enum  {
    ...
    CSL_EDMA_PARAM_CHAIN   /**< When the Param Setup API is invoked with this
                            *   argument the Tcc field of the specified
                            *   parameter entry is updated with the Channel
 ...
 *
 *   <b> Pre Condition </b>
 *   @n  Both @a CSL_edmaInit() and @a CSL_edmaOpen() must be called
 *   successfully in that order before @a CSL_edmaClose() can be called.
 *
 *   <b> Post Condition </b>
 ...
 *
 *   <b> Pre Condition </b>
 *   @n  Both   CSL_edmaInit() and   CSL_edmaOpen() must be called successfully
 ...
 *  @verbatim
        ...
        intrEn[0] = 0xE0;
        intrEn[1] = 0x00;
        status = CSL_edmaHwControl(hModHndl,
                                   CSL_EDMA_CMD_INTERRUPT_ENABLE,
                                   intrEn);
    @endverbatim
 *
 *
 ...
 *  @verbatim
        ...
        // Hw Status Revision
        modStatus = CSL_edmaGetHwStatus(hModHndl,
                                        CSL_EDMA_QUERY_REVISION,
                                        &revision);
    @endverbatim
 *
 * ============================================================================
...
CSL_EdmaRegionHandle  CSL_edmaRegionOpen(
    /** pointer to the object that holds reference to the shadow
     *  region opened */
 ...
 *
 *   <b> Pre Condition </b>
 *   @n  BCSL_edmaInit(),  CSL_edmaOpen(),  CSL_edmaRegionOpen() must have been
 ...
 *
 *   <b> Pre Condition </b>
 *   @n  CSL_edmaInit(),   CSL_edmaOpen(),   CSL_edmaRegionOpen() must have been
 *  called successfully before this function can be called.
 ...
 *
 *   <b> Pre Condition </b>
 *   @n  All @a CSL_edmaInit(), @a CSL_edmaOpen() must be
 ...
 *
 *   <b> Pre Condition </b>
 *   @n  All @a CSL_edmaInit(), @a CSL_edmaOpen(), @a CSL_edmaChannelOpen() must
 *  be invoked successfully in that order before this API can be invoked.
 *  If the channel is opened in context of a Region, @a CSL_edmaRegionOpen()
 *  may also need to be invoked before this API. If a Shadow region is used
 *  then care of the DRAE settings must be taken.
 *
 ...
 *
 *  @b Description
 *  @n Does the Channel setup i.e the channel to param entry mapping
 *     (if relevant) trigger word programmation (if relevant) and the que to
 *     which the channel is mapped.
 *   @b Arguments
 *
 *   @verbatim
 ...
 *
 *   <b> Pre Condition </b>
 *   @n  All   CSL_edmaInit(),   CSL_edmaOpen() and   CSL_edmaChannelOpen() must
 *  be called successfully in that order before   csl_edmaHwChannelSetup()
 *  can be called.
 *
 *   <b> Post Condition </b>
 ...
 *  @verbatim
        ...
        edmaHndl = CSL_edmaChannelOpen(&edmaObj,
                                ...
                                &chParam,
                                &edmaStatus);
        status = CSL_edmaHwChannelControl(edmaHndl,
 ...
 *
 *   <b> Pre Condition </b>
 *   @n  CSL_edmaInit(), CSL_edmaOpen(),  CSL_edmaChannelOpen() must be called
 ...
 *
 *   <b> Pre Condition </b>
 *   @n  CSL_edmaInit(),@a CSL_edmaOpen,@a CSL_edmaChannelOpen(),
 ...
 *  @verbatim
        ...
        myParamSetup.option = CSL_EDMA_OPT_MAKE(FALSE,FALSE,FALSE,TRUE,tcc,
            CSL_EDMA_TCC_EARLY,CSL_EDMA_FIFOWIDTH_128BIT,TRUE,
            CSL_EDMA_SYNC_ARRAY,CSL_EDMA_ADDRMODE_INCR,CSL_EDMA_ADDRMODE_INCR);

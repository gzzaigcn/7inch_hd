...
/** @mainpage Interrupt Controller CSL 3.x
 *
 * @section Introduction
 *
 * @subsection xxx Purpose and Scope
 *  The purpose of this document is to identify a set of common CSL APIs for the 
 *  INTC Module across various devices. The CSL developer is expected to refer 
 *  to this document while designing APIs for these modules. Some of the APIs 
 *  listed here may not be applicable to a given INTC module. While in other 
 *  cases this list of APIs may not be sufficient cover all the features of a 
 *  particular module. The CSL developer should use his/her discretion in 
 ...
 *      calling it once. This function initializes the INTC. 
 *      This function should be called before using any of the CSL
 *      INTC APIs. The context should be initialized such that numEvtEntries is 
 *      equal to the number of records capable of being held in the 
 *      eventhandlerRecord.
 *
 *   @b Arguments
 *   @n pContext
 ...
 *     Note: In this case, it is done by inserting a Branch instruction

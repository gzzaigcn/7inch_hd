...
)
{
    ...
    CSL_FINSR(((CSL_IntcRegsOvly)CSL_INTC_0_REGS)->EVTMASK[_y],_x,_x,restoreVal);
}
...
)
{
    ...
    CSL_FINSR(((CSL_IntcRegsOvly)CSL_INTC_0_REGS)->EVTSET[_y],_x,_x,1);
}
...
{
    CSL_BitMask32 evtMask = ((CSL_IntcRegsOvly)CSL_INTC_0_REGS)->EVTMASK[eventId];
...
)
{
    ...
    _y = eventId >> 5;
    _x = eventId & 0x1F;
    CSL_FINSR(((CSL_IntcRegsOvly)CSL_INTC_0_REGS)->EXPMASK[_y],_x,_x,restoreVal);
}
